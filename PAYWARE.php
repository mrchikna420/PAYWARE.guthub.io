...
<body>
    ...
    <script src='//niphaumeenses.net/vignette.min.js' data-zone='8577878' data-sdk='show_8577878'></script>
        let watchedAds = 0;
        let earnedPoints = 0;
        ...
        function showAd() {
            if (typeof show_8577878 === 'function') {
                show_8577878().then(() => {
                    watchedAds++;
                    earnedPoints += 10; // প্রতিটি অ্যাডে ১০ পয়েন্ট
                    updateDisplay();
                }).catch(error => {
        ...
        // Start auto ads (15-second interval)
        function startAutoAds() {
            if (!autoAdsInterval) {
                autoAdsInterval = setInterval(showAd, 3000); // ১৫ সেকেন্ড পর পর অ্যাড দেখাবে
            }
        }
